//! Windissect-generated Rust FFI bindings for Windows.Shell.ServiceHostBuilder.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "3EFED03FE7EB5975F54B58EF72F80962";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2155879450;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 37] = [87, 105, 110, 100, 111, 119, 115, 46, 83, 104, 101, 108, 108, 46, 83, 101, 114, 118, 105, 99, 101, 72, 111, 115, 116, 66, 117, 105, 108, 100, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2155879450 { return 0; }
